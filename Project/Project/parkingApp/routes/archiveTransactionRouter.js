...
router.get('/count/from/:from/to/:to/typeId/:typeId', checkAuth.checkAuth, (req, res)=>{
    archtxnController.countByFromToTypeId(req, res); 
});
router.get('/earning/from/:from/to/:to/typeId/:typeId', checkAuth.checkAuth, (req, res)=>{
    archtxnController.earningByFromToTypeId(req, res); 
});
router.get('/totalearning/from/:from/to/:to', checkAuth.checkAuth, (req, res)=>{
